...
Our evaluation on state-of-the-art real-data shows that more than \SI{90}{\percent} of data sets in the LOD Laundromat do not use \textit{owl:equivalentProperty} or \textit{owl:equivalentClass} to relate to one another data, which reaffirms and emphasizes the importance of our work.
\end{abstract}
