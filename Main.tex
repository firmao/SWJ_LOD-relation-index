...
{
\begin{tabular}{cccS[table-format=1.2e1]cc} \hline
...
\begin{table}[H]
    ...
    \hline
    \textbf{URIs indexed} & 4185133445 & 31121342 & 4216254787 \\ \hline
    \textbf{Datasets checked} & 658206 & 9960 & 668166 \\ \hline
...
\begin{table}[htb]
\centering
\begin{tabular}{lS[table-format=9.0]S[table-format=8.0]S[table-format=10.0]} \hline
\textbf{Dataset} & \textbf{\#ExactMatch} & \textbf{\#sim > 0.8} & \textbf{\#PropClass} \\  \hline
...
\begin{table}[htb]
    ...
    \textbf{\#Datasets} & \textbf{\#DsPropMatch} & \textbf{time (s)} & \textbf{\#triples} & \textbf{Synthetic} \\ \hline
    3 & 2 & 1 & 11 & yes \\ \hline
